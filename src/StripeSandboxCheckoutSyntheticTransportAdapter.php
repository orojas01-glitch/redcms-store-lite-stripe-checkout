...
/**
 * P3E-4 orchestration of synthetic credential, bytes, codec, and executor.
 *
 * The concrete transport owns the synthetic credential. This adapter never
 * accepts, reads, hashes, returns, or logs credential material.
 */
final class RED_CMS_Store_Lite_Stripe_Sandbox_Checkout_Synthetic_Transport_Adapter
{
    public static function execute(
        ...
        if (!class_exists(
            ...
            return self::refused('', 'synthetic_contract_unavailable');
        }
