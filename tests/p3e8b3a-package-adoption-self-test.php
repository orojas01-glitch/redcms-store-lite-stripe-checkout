...
try {
    ...
    red_stripe_p3e8b3a_assert(
        ...
        'later identity preserves B3A transport adoption in 0.1.5'
    );
    red_stripe_p3e8b3a_assert(
    ...
    red_stripe_p3e8b3a_assert(
        ...
        'later 0.1.5 preserves both append-only migration checksums'
    );
    ...
    red_stripe_p3e8b3a_assert(
        ...
        'integrity inventory lists the exact fourteen payload files'
    );
    ...
    red_stripe_p3e8b3a_assert(
        substr_count($handler, "'stripe.secret-key'") === 4
            && substr_count($handler, "'stripe.webhook-secret'") === 4,
        'all four operations use only declared secret keys'
    );
